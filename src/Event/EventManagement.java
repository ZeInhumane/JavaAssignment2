...
public class EventManagement {
    ...
    /**
     * Show all events using a Message Dialog.
     * This may be changed to return a string instead of displaying a dialog.
     */
    ...
    /**
     * Delete an event on a given name. 
     * Capitalization doesn't matter. Uses the utility method, searchByName()
     * @param inEventName
     */
